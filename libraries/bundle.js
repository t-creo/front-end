...
},{"./swearwords.json":5,"./util":6}],5:[function(require,module,exports){
module.exports=[
    "4r5e",
    "5h1t",
    "5hit",
...
},{}],"simple-spam-filter":[function(require,module,exports){
...
var debug = require('debug')('simple-spam-filter')
...
SimpleSpamFilter.prototype.isSpam = function (tweet) {
  if (this.minWords !== undefined &&
    ...
    debug('`%s` does not meet minimum word requirement', tweet)
    return true
  }

  if (this.maxPercentCaps !== undefined &&
    percentCaps(tweet) > this.maxPercentCaps) {
    debug('`%s` exceeds max percentage of capitalized characters', tweet)
    return true
  }

  if (this.maxNumSwearWords !== undefined &&
    numSwearWords(tweet) > this.maxNumSwearWords) {
    debug('`%s` exceeds max number of swear words', tweet)
    return true
  }

  debug('`%s` is not spam', tweet)
  return false
}
...
function numSwearWords (tweet) {
  return profanity.check(tweet).length
}
...
module.exports = SimpleSpamFilter

},{"debug":1,"profanity-util":4}]},{},[]);
